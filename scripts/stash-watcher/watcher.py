...
if __name__ == "__main__":
    ...
    # Set up Stash
    stashArgs = {"scheme": config["Host"]["Scheme"], "host": config["Host"]["Host"], "port": config["Host"]["Port"]}
    ...
    if not extensions:
        ...
        extensions = (
            stashConfig["general"]["videoExtensions"] + stashConfig["general"]["imageExtensions"] + stashConfig["general"]["galleryExtensions"]
        )
