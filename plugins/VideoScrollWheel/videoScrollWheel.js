    ...
    function onWheel(e) {
        ...
        if (targetWidth / 2 > targetX) {
            ...
            if (deltaTime === 0) {
                ...
                scrollVelocity = scrollVelocity - (scrollVelocity * timeScrollFriction * deltaTime) + ((1 / deltaTime) * timeScrollAcceleration)
                scrollVelocity = Math.max(1, Math.min(scrollVelocity, maxTimeScrollVelocity));
            }
