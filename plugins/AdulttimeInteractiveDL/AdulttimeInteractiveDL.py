...
def get_download():
    ...
    },fragment=SLIM_SCENE_FRAGMENT, get_count=True)
    ...
    for i, scene in enumerate(scenes):
        ...
        if dlapires["code"] == 0:
            ...
            if os.path.isfile(fppatw) == False:
                ...
                open(fppatw, 'w+').write(rpat.content.decode('utf-8'))
...
def convert_lovense_to_funscript(sceneinfo,patternfile,funscriptfile):
    ...
    for la in lovensactions:
        ...
        if la["t"] == 0:
            ...
            marker_pos = (la["t"])*1
            data['actions'].extend([{"pos": int(marker_at+0.5), "at": int(marker_pos+0.5)}])
