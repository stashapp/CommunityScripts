(function () {
  ...
  function create_fragment$7(ctx) {
  	...
  	const block = {
  		...
  		m: function mount(target, anchor) {
  			...
  			if (!mounted) {
  				dispose = listen_dev(div, "keydown", /*handleKeyDown*/ ctx[1], false, false, false, false);
  				mounted = true;
  			}
  		},
  ...
  function create_fragment$6(ctx) {
  	...
  	const block = {
  		...
  		m: function mount(target, anchor) {
  			...
  			if (!mounted) {
  				dispose = listen_dev(li, "click", /*click_handler*/ ctx[11], false, false, false, false);
  				mounted = true;
  			}
  		},
  		p: function update(ctx, [dirty]) {
  ...
  function create_if_block(ctx) {
  	...
  	const block = {
  		c: function create() {
  			...
  			add_location(div5, file$3, 118, 2, 3083);
  		},
  		m: function mount(target, anchor) {
  			...
  			if (!mounted) {
  				dispose = [
  					listen_dev(button0, "click", /*close*/ ctx[3], false, false, false, false),
  ...
  function create_default_slot_3(ctx) {
  	...
  	const block = {
  		c: function create() {
  			img = element("img");
  			t = space();
  			if (!src_url_equal(img.src, img_src_value = "data:image/jpg;base64," + /*face*/ ctx[10].image)) attr_dev(img, "src", img_src_value);
  			attr_dev(img, "alt", "");
  			attr_dev(img, "class", "face-tab svelte-ssoxzi");
  			add_location(img, file$3, 135, 18, 3562);
  		},
  		m: function mount(target, anchor) {
  ...
  // (134:14) {#each matches as face, i (face.image)}
  function create_each_block_2(key_1, ctx) {
  	...
  	dispatch_dev("SvelteRegisterBlock", {
  		...
  		type: "each",
  		source: "(134:14) {#each matches as face, i (face.image)}",
  		ctx
  	});
  ...
  // (150:20) {#each performers as match, i (match.id)}
  function create_each_block_1(key_1, ctx) {
  	...
  	const block = {
  		...
  		c: function create() {
  			...
  			if (!src_url_equal(img.src, img_src_value = /*match*/ ctx[14].image)) attr_dev(img, "src", img_src_value);
  			add_location(img, file$3, 160, 26, 4544);
  			attr_dev(span0, "class", span0_class_value = "performer-card__country-flag fi fi-" + /*match*/ ctx[14].country?.toLowerCase() + " svelte-ssoxzi");
  			add_location(span0, file$3, 166, 26, 4795);
  			attr_dev(div0, "class", "thumbnail-section svelte-ssoxzi");
  			add_location(div0, file$3, 159, 24, 4486);
  			attr_dev(a, "href", a_href_value = "https://stashdb.org/performers/" + /*match*/ ctx[14].id);
  			attr_dev(a, "target", "_blank");
  			attr_dev(a, "class", "svelte-ssoxzi");
  			add_location(a, file$3, 173, 30, 5179);
  			attr_dev(div1, "class", "svelte-ssoxzi");
  			add_location(div1, file$3, 180, 33, 5526);
  			attr_dev(span1, "class", "tag-item badge badge-pill svelte-ssoxzi");
  			add_location(span1, file$3, 179, 30, 5453);
  			set_style(div2, "-webkit-line-clamp", "2");
  			attr_dev(div2, "class", "svelte-ssoxzi");
  			add_location(div2, file$3, 172, 28, 5113);
  			attr_dev(h5, "class", "card-section-title flex-aligned svelte-ssoxzi");
  			add_location(h5, file$3, 171, 26, 5040);
  			attr_dev(div3, "class", "card-section svelte-ssoxzi");
  			add_location(div3, file$3, 170, 24, 4987);
  			...
  			add_location(div4, file$3, 150, 22, 4070);
  			this.first = div4;
  		},
  		m: function mount(target, anchor) {
  			...
  			if (!mounted) {
  				dispose = [
  					...
  					listen_dev(div4, "click", click_handler, false, false, false, false),
  					listen_dev(div4, "keypress", keypress_handler, false, false, false, false)
  				];
  		...
  		p: function update(new_ctx, dirty) {
  			...
  			if (dirty & /*matches*/ 1 && t2_value !== (t2_value = /*match*/ ctx[14].name + "")) set_data_dev(t2, t2_value);

  			if (dirty & /*matches*/ 1 && a_href_value !== (a_href_value = "https://stashdb.org/performers/" + /*match*/ ctx[14].id)) {
  				attr_dev(a, "href", a_href_value);
  			}

  			if (dirty & /*matches*/ 1 && t4_value !== (t4_value = /*match*/ ctx[14].confidence + "")) set_data_dev(t4, t4_value);
  	...
  	dispatch_dev("SvelteRegisterBlock", {
  		...
  		type: "each",
  		source: "(150:20) {#each performers as match, i (match.id)}",
  		ctx
  	});
  ...
  function create_default_slot_1(ctx) {
  	...
  	const block = {
  		c: function create() {
  			...
  			add_location(div0, file$3, 148, 18, 3963);
  			attr_dev(div1, "class", "row svelte-ssoxzi");
  			add_location(div1, file$3, 147, 16, 3927);
  		},
  		m: function mount(target, anchor) {
  ...
  // (145:12) {#each matches as face, i (face.image)}
  function create_each_block$1(key_1, ctx) {
  	...
  	dispatch_dev("SvelteRegisterBlock", {
  		...
  		type: "each",
  		source: "(145:12) {#each matches as face, i (face.image)}",
  		ctx
  	});
  ...
  function instance$3($$self, $$props, $$invalidate) {
  	...
  	$$self.$inject_state = $$props => {
  		if ('matches' in $$props) $$invalidate(0, matches = $$props.matches);
  		if ('matchesSelected' in $$props) matchesSelected = $$props.matchesSelected;
  ...
  function instance$2($$self, $$props, $$invalidate) {
  	...
  	Object.keys($$props).forEach(key => {
  		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console_1.warn(`<SearchFaces> was created with unknown prop '${key}'`);
  	});
  ...
  class SearchFaces extends SvelteComponentDev {
  	...
  	set calls(value) {
  		throw new Error("<SearchFaces>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
  	}
  }
  ...
  function create_each_block(key_1, ctx) {
  	...
  	const block = {
  		...
  		c: function create() {
  			...
  			attr_dev(div0, "data-offset", div0_data_offset_value = /*frame*/ ctx[10].offset);
  		...
  		m: function mount(target, anchor) {
  			...
  			if (!mounted) {
  				dispose = listen_dev(div0, "click", click_handler, false, false, false, false);
  				mounted = true;
  			}
  		},
  		p: function update(new_ctx, dirty) {
  ...
  function instance$1($$self, $$props, $$invalidate) {
  	...
  	Object.keys($$props).forEach(key => {
  		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console.warn(`<Faces> was created with unknown prop '${key}'`);
  	});
  ...
  class Faces extends SvelteComponentDev {
  	...
  	get url() {
  		throw new Error("<Faces>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
  	}

  	set url(value) {
  		throw new Error("<Faces>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
  	}
  ...
  function create_fragment(ctx) {
  	...
  	const block = {
  		c: function create() {
  			...
  			svg = svg_element("svg");
  			path = svg_element("path");
  			attr_dev(path, "d", "M17,10.5L21,6.5V17.5L17,13.5V17A1,1 0 0,1 16,18H4A1,1 0 0,1 3,17V7A1,1 0 0,1 4,6H16A1,1 0 0,1 17,7V10.5M14,16V15C14,13.67 11.33,13 10,13C8.67,13 6,13.67 6,15V16H14M10,8A2,2 0 0,0 8,10A2,2 0 0,0 10,12A2,2 0 0,0 12,10A2,2 0 0,0 10,8Z");
  		...
  		m: function mount(target, anchor) {
  			...
  			if (!mounted) {
  				dispose = listen_dev(button, "click", /*getFaces*/ ctx[1], false, false, false, false);
  				mounted = true;
  			}
  		},
  		p: function update(ctx, [dirty]) {
  ...
  function instance($$self, $$props, $$invalidate) {
  	...
  	Object.keys($$props).forEach(key => {
  		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console.warn(`<FindFaces> was created with unknown prop '${key}'`);
  	});
