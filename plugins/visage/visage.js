(function () {
  ...
  let VISAGE_API_URL = "https://cc1234-stashface.hf.space";
    ...
    if (!gradioClientModule) {
      try {
        ...
        if (typeof window !== 'undefined') {
          if (!window.Buffer) {
            // Create a proper Buffer constructor for instanceof checks
        ...
        console.log('Loading Gradio client from CDN...');
        const module = await import('https://cdn.jsdelivr.net/npm/@gradio/client@1.15.3/dist/index.js');
        console.log('Gradio client loaded:', module);
        gradioClientModule = module;
      } catch (error) {
        console.error('Failed to load Gradio client:', error);
        throw new Error(`Could not load Gradio client: ${error.message}`);
      }
    }
    return gradioClientModule;
  }

  /**
   * Gets or creates a Gradio client connection
   * @returns {Promise<Client>} - The Gradio client instance
   */
  async function getGradioClient() {
    if (!gradioClient) {
      const { Client } = await loadGradioClient();
      gradioClient = await Client.connect(VISAGE_API_URL);
    }
    return gradioClient;
  }
  ...
  /**
   * Creates a file handle for Gradio API
   * @param {Blob} blob - The blob to convert to file handle
   * @returns {Promise<Object>} - The file handle
   */
  async function createFileHandle(blob) {
    try {
      // Ensure we have a valid blob-like object
      if (!blob || typeof blob !== 'object') {
        throw new Error('Invalid blob provided to createFileHandle');
      }
      
      const { handle_file } = await loadGradioClient();
      if (!handle_file || typeof handle_file !== 'function') {
        throw new Error('handle_file function not available from Gradio client');
      }
      
      return handle_file(blob);
    } catch (error) {
      console.error('Error in createFileHandle:', error);
      throw new Error(`File handle creation failed: ${error.message}`);
    }
  }

  /**
   * Calls the Gradio API using the official client
   * @param {string} endpoint - The API endpoint name (e.g., 'image_search', 'find_faces_in_sprite')
   * @param {Array} inputs - The input parameters for the API call
   * @returns {Promise<Object>} - The API response data
   */
  async function callGradioAPI(endpoint, inputs) {
    try {
      const client = await getGradioClient();
      const result = await client.predict(`/${endpoint}`, inputs);
      return result;
    } catch (error) {
      throw new Error(`Gradio API call failed: ${error.message}`);
    }
  }
  ...
  function create_if_block(ctx) {
  	...
  	return {
  		c() {
  			...
  			attr(div0, "class", "modal-body svelte-ssoxzi");
  			attr(button0, "id", "face_close");
  			attr(button0, "type", "button");
  			attr(button0, "class", "ml-2 btn btn-secondary svelte-ssoxzi");
  			attr(button1, "id", "face_toggle");
  			attr(button1, "type", "button");
  			attr(button1, "class", "ml-2 btn btn-secondary svelte-ssoxzi");
  			attr(div1, "class", "svelte-ssoxzi");
  			attr(div2, "class", "ModalFooter modal-footer svelte-ssoxzi");
  			attr(div3, "class", "modal-content svelte-ssoxzi");
  			attr(div4, "class", "modal-dialog modal-xl svelte-ssoxzi");
  			attr(div5, "role", "dialog");
  			attr(div5, "aria-modal", "true");
  			attr(div5, "class", "fade ModalComponent modal show svelte-ssoxzi");
  		...
  		m(target, anchor) {
  			...
  			if (!mounted) {
  				dispose = [
  					listen(button0, "click", /*close*/ ctx[3]),
  					listen(button1, "click", /*toggle*/ ctx[4])
  				];
  		...
  		i(local) {
  			...
  			add_render_callback(() => {
  				...
  				div5_intro = create_in_transition(div5, fly, { y: 100, duration: 400 });
  				div5_intro.start();
  			});
  		...
  		o(local) {
  			...
  			div5_outro = create_out_transition(div5, fly, { y: -100, duration: 400 });
  			current = false;
  		},
  		d(detaching) {
  ...
  function create_default_slot_3(ctx) {
  	...
  	return {
  		c() {
  			img = element("img");
  			t = space();
  			if (!src_url_equal(img.src, img_src_value = "data:image/jpg;base64," + /*face*/ ctx[10].image)) attr(img, "src", img_src_value);
  			attr(img, "alt", "");
  			attr(img, "class", "face-tab svelte-ssoxzi");
  		},
  		m(target, anchor) {
  		...
  		p(ctx, dirty) {
  			if (dirty & /*matches*/ 1 && !src_url_equal(img.src, img_src_value = "data:image/jpg;base64," + /*face*/ ctx[10].image)) {
  ...
  function create_each_block_1(key_1, ctx) {
  	...
  	return {
  		...
  		c() {
  			...
  			t5 = text("%");
  			t6 = space();
  			attr(img, "class", "performer-card-image svelte-ssoxzi");
  			attr(img, "alt", img_alt_value = /*match*/ ctx[14].name);
  			if (!src_url_equal(img.src, img_src_value = /*match*/ ctx[14].image)) attr(img, "src", img_src_value);
  			attr(span0, "class", span0_class_value = "performer-card__country-flag fi fi-" + /*match*/ ctx[14].country?.toLowerCase() + " svelte-ssoxzi");
  			attr(div0, "class", "thumbnail-section svelte-ssoxzi");
  			attr(a, "href", a_href_value = "https://stashdb.org/performers/" + /*match*/ ctx[14].id);
  			attr(a, "target", "_blank");
  			attr(a, "class", "svelte-ssoxzi");
  			attr(div1, "class", "svelte-ssoxzi");
  			attr(span1, "class", "tag-item badge badge-pill svelte-ssoxzi");
  			set_style(div2, "-webkit-line-clamp", "2");
  			attr(div2, "class", "svelte-ssoxzi");
  			attr(h5, "class", "card-section-title flex-aligned svelte-ssoxzi");
  			attr(div3, "class", "card-section svelte-ssoxzi");
  			attr(div4, "draggable", "false");
  			attr(div4, "class", "performer-card grid-card card svelte-ssoxzi");
  			attr(div4, "id", div4_id_value = "face-" + /*i*/ ctx[13]);
  			this.first = div4;
  		},
  		m(target, anchor) {
  		...
  		p(new_ctx, dirty) {
  			...
  			if (dirty & /*matches*/ 1 && img_alt_value !== (img_alt_value = /*match*/ ctx[14].name)) {
  				attr(img, "alt", img_alt_value);
  			}

  			if (dirty & /*matches*/ 1 && !src_url_equal(img.src, img_src_value = /*match*/ ctx[14].image)) {
  				attr(img, "src", img_src_value);
  			}

  			if (dirty & /*matches*/ 1 && span0_class_value !== (span0_class_value = "performer-card__country-flag fi fi-" + /*match*/ ctx[14].country?.toLowerCase() + " svelte-ssoxzi")) {
  				attr(span0, "class", span0_class_value);
  			}

  			if (dirty & /*matches*/ 1 && t2_value !== (t2_value = /*match*/ ctx[14].name + "")) set_data(t2, t2_value);

  			if (dirty & /*matches*/ 1 && a_href_value !== (a_href_value = "https://stashdb.org/performers/" + /*match*/ ctx[14].id)) {
  				attr(a, "href", a_href_value);
  			}

  			if (dirty & /*matches*/ 1 && t4_value !== (t4_value = /*match*/ ctx[14].confidence + "")) set_data(t4, t4_value);

  			if (dirty & /*matches*/ 1 && div4_id_value !== (div4_id_value = "face-" + /*i*/ ctx[13])) {
  ...
  function create_default_slot_1(ctx) {
  	...
  	return {
  		c() {
  			...
  			t = space();
  			attr(div0, "class", "carousel svelte-ssoxzi");
  			attr(div1, "class", "row svelte-ssoxzi");
  		},
  		m(target, anchor) {
  ...
  function instance$3($$self, $$props, $$invalidate) {
  	...
  	function toggle() {
  		$$invalidate(2, modal.style.opacity = modal.style.opacity == "0.1" ? "1.0" : "0.1", modal);
  	}
  	...
  	const click_handler = (match, event) => addPerformer(event.target, match.id);
  	const keypress_handler = (match, event) => addPerformer(event.target, match.id);
  ...
  class Match extends SvelteComponent {
  	constructor(options) {
  		super();
  		init(this, options, instance$3, create_fragment$3, safe_not_equal, { matches: 0 });
  	}
  }
  ...
  function create_fragment$2(ctx) {
  	...
  	return {
  		...
  		m(target, anchor) {
  			...
  			if (!mounted) {
  				dispose = listen(button, "click", /*recognize*/ ctx[1]);
  				mounted = true;
  			}
  		},
  		p(ctx, [dirty]) {
  ...
  function instance$2($$self, $$props, $$invalidate) {
  	...
  	function recognize() {
  		...
  		html2canvas(document.querySelector(selector)).then(async canvas => {
  			$$invalidate(0, scanner = true);
  			let image = canvas.toDataURL("image/jpg");

  			// Convert data URL to blob for Gradio client
  			const imageBlob = dataUrlToBlob(image);

  			try {
  				const result = await callGradioAPI("multiple_image_search", [await createFileHandle(imageBlob), THRESHOLD, MAX_RESULTS]);
  ...
  class SearchFaces extends SvelteComponent {
  	constructor(options) {
  		super();
  		init(this, options, instance$2, create_fragment$2, safe_not_equal, { calls: 2 });
  	}
  ...
  function create_each_block(key_1, ctx) {
  	...
  	return {
  		...
  		c() {
  			...
  			div0 = element("div");
  			t = space();
  			attr(div0, "class", "face-item svelte-p95y28");
  			set_style(div0, "background-position", "-" + /*frame*/ ctx[10].offset[0] + "px -" + /*frame*/ ctx[10].offset[1] + "px");
  			set_style(div0, "background-image", "url('" + /*url*/ ctx[0] + "')");
  			attr(div0, "data-offset", div0_data_offset_value = /*frame*/ ctx[10].offset);
  			set_style(div1, "padding", "10px");
  			attr(div2, "class", "svelte-p95y28");
  			toggle_class(div2, "selected", /*selected*/ ctx[3] === /*frame*/ ctx[10].id);
  			this.first = div2;
  		},
  		m(target, anchor) {
  		...
  		p(new_ctx, dirty) {
  			...
  			if (!current || dirty & /*frames*/ 2 && div0_data_offset_value !== (div0_data_offset_value = /*frame*/ ctx[10].offset)) {
  		...
  		a() {
  			stop_animation();
  			stop_animation = create_animation(div2, rect, flip, { duration: 250, easing: quintOut });
  		},
  		i(local) {
  			if (current) return;
  ...
  function create_fragment$1(ctx) {
  	...
  	searchfaces = new SearchFaces({ props: searchfaces_props });
  	binding_callbacks.push(() => bind(searchfaces, 'calls', searchfaces_calls_binding));
  	...
  	return {
  		c() {
  			...
  			attr(button, "id", "tags-cancel");
  			attr(button, "type", "button");
  			attr(button, "class", "ml-2 btn btn-secondary");
  			attr(div1, "class", "ModalFooter modal-header");
  			attr(div2, "class", "row justify-content-center");
  			attr(div3, "class", "modal-body");
  			attr(div4, "class", "modal-content");
  			attr(div5, "class", "modal-dialog modal-xl top-accent");
  			attr(div6, "class", "face-tabs svelte-p95y28");
  		},
  		m(target, anchor) {
  ...
  class Faces extends SvelteComponent {
  	constructor(options) {
  		super();
  		init(this, options, instance$1, create_fragment$1, safe_not_equal, { url: 0, frames: 1 });
  	}
  }
  ...
  function create_fragment(ctx) {
  	...
  	return {
  		c() {
  			button = element("button");
  			button.innerHTML = `<svg xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" viewBox="0 0 24 24" class="svelte-1m5gxnd"><path d="M17,10.5L21,6.5V17.5L17,13.5V17A1,1 0 0,1 16,18H4A1,1 0 0,1 3,17V7A1,1 0 0,1 4,6H16A1,1 0 0,1 17,7V10.5M14,16V15C14,13.67 11.33,13 10,13C8.67,13 6,13.67 6,15V16H14M10,8A2,2 0 0,0 8,10A2,2 0 0,0 10,12A2,2 0 0,0 12,10A2,2 0 0,0 10,8Z"></path></svg>`;
  			attr(button, "id", "faces");
  			attr(button, "class", "svelte-1m5gxnd");
  			toggle_class(button, "scanner", /*scanner*/ ctx[0]);
  		},
  		m(target, anchor) {
  			...
  			if (!mounted) {
  				dispose = listen(button, "click", /*getFaces*/ ctx[1]);
  				mounted = true;
  			}
  		},
  		p(ctx, [dirty]) {
  ...
  function instance($$self, $$props, $$invalidate) {
  	...
  	async function getFaces() {
  		...
  		// Convert data URLs to files for Gradio client
  		const imageBlob = dataUrlToBlob(image);

  		const vttBlob = dataUrlToBlob(vtt);

  		try {
  			const result = await callGradioAPI("find_faces_in_sprite", [await createFileHandle(imageBlob), await createFileHandle(vttBlob)]);
  			$$invalidate(0, scanner = false);
  			...
  			new Faces({
  					target: row,
  					props: { frames: result.data[0], url }
  				});
  		} catch(error) {
  			$$invalidate(0, scanner = false);
  ...
  class FindFaces extends SvelteComponent {
  	constructor(options) {
  		super();
  ...
  stash.addEventListener("stash:page:scene", function () {
      let elms = ".scene-toolbar-group:nth-child(2)";
  ...
  stash.addEventListener("stash:page:image", function () {
      let elms = ".image-toolbar-group:nth-child(2)";
      waitForElm(elms).then(() => {
          if (!document.querySelector("#visage")) {
              const e = document.querySelector(elms);
              new SearchFaces({ target: e });
