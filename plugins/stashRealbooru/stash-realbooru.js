    ...
    function create_fragment$2(ctx) {
        ...
        const block = {
            ...
            p: function update(ctx, [dirty]) {
                if (
                    dirty & /*prob*/ 4 &&
                    div0_class_value !== (div0_class_value = "progress-bar progress-bar-striped bg-" + confidence(/*prob*/ ctx[2]) + " svelte-ai57u1")
                ) {
    ...
    function create_each_block(key_1, ctx) {
        ...
        const block = {
            ...
            p: function update(new_ctx, dirty) {
                ...
                const tag_changes = dirty & /*filteredMatches*/ 16 ? get_spread_update(tag_spread_levels, [get_spread_object(/*tag*/ ctx[13])]) : {}
