...
class StashInterface:
    ...
    def get_tags_with_relations(self):
        ...
        variables = {
            "tag_filter": {"child_count": {"modifier": "GREATER_THAN", "value": 0}, "OR": {"parent_count": {"modifier": "GREATER_THAN", "value": 0}}},
            "filter": {"q": "", "per_page": -1},
        }
...
def generate_graph(stash_connection):
    ...
    node_theme = {"border": "#adb5bd", "background": "#394b59", "highlight": {"border": "#137cbd", "background": "#FFFFFF"}}
