;(function () {
        ...
        const block = {
            c: function create() {
                ...
                attr_dev(
                    div1,
                    "class",
                    (div1_class_value = "progress-bar progress-bar-striped bg-" + confidence$1(/*frame*/ ctx[0].tag.prob) + " svelte-zeu5yg")
                )
    ...
    function instance$5($$self, $$props, $$invalidate) {
        ...
        return [frame, url, dispatch, click_handler, click_handler_1, select_change_handler, click_handler_2]
    }
        ...
        const block = {
            c: function create() {
                ...
                attr_dev(
                    div1,
                    "class",
                    (div1_class_value = "progress-bar progress-bar-striped bg-" + confidence(/*data*/ ctx[1].prob) + " svelte-1d03wug")
                )
                attr_dev(div1, "role", "progressbar")
