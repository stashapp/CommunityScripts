(function () {
  ...
  function instance$5($$self, $$props, $$invalidate) {
    ...
    $$self.$$.on_mount.push(function () {
      if (
        frame === undefined &&
        !("frame" in $$props || $$self.$$.bound[$$self.$$.props["frame"]])
      ) {
    ...
    const block = {
      ...
      p: function update(ctx, [dirty]) {
        ...
        if (
          ...
          t2_value !== (t2_value = /*threshold*/ ctx[0] * 100 + "")
        )
          set_data_dev(t2, t2_value);

        if (
          dirty &
          /*selected, filteredFrames, url, addMarker, remove, select*/ 938
        ) {
  ...
  function instance$4($$self, $$props, $$invalidate) {
    ...
    Object.keys($$props).forEach((key) => {
      if (
        ...
        console.warn(`<MarkerMatches> was created with unknown prop '${key}'`);
    });
    ...
    function marker_frame_binding(value, frame, each_value, frame_index) {
      ...
      ($$invalidate(5, filteredFrames), $$invalidate(11, frames)),
        $$invalidate(0, threshold);
    }
    ...
    $$self.$inject_state = ($$props) => {
      ...
      if ("filteredFrames" in $$props)
        $$invalidate(5, (filteredFrames = $$props.filteredFrames));
    };
  ...
  function instance$3($$self, $$props, $$invalidate) {
    ...
    Object.keys($$props).forEach((key) => {
      if (
        ...
        console.warn(`<MarkerButton> was created with unknown prop '${key}'`);
    });
  ...
  function instance$2($$self, $$props, $$invalidate) {
    ...
    $$self.$$.on_mount.push(function () {
      ...
      if (
        data === undefined &&
        !("data" in $$props || $$self.$$.bound[$$self.$$.props["data"]])
      ) {
  ...
  function create_each_block(key_1, ctx) {
    ...
    const block = {
      ...
      p: function update(new_ctx, dirty) {
        ctx = new_ctx;
        const tag_changes = {};
        if (dirty & /*filteredMatches*/ 32)
          tag_changes.data = /*tagData*/ ctx[16];
  ...
  function instance$1($$self, $$props, $$invalidate) {
    ...
    function tag_name_binding(value, tagName, each_value, each_index) {
      ...
      ($$invalidate(5, filteredMatches), $$invalidate(10, matches)),
        $$invalidate(0, threshold);
    }
    ...
    $$self.$inject_state = ($$props) => {
      ...
      if ("filteredMatches" in $$props)
        $$invalidate(5, (filteredMatches = $$props.filteredMatches));
    };
