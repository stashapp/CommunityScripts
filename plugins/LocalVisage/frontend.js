(function () {
   ...
   * If the client is not available, attempts to start the server and retries for up to 1 minute.
  ...
  async function getGradioClient() {
    ...
    for (let attempt = 0; attempt < MAX_RETRIES; attempt++) {
      try {
        ...
        lastError = error;
        console.warn(
          `Gradio client connection failed (attempt ${
            attempt + 1
        ...
        if (attempt === 0) {
          try {
            await startServer();
            console.info("Called startServer() after Gradio client failure.");
          } catch (e) {
            console.warn("startServer() also failed:", e);
          }
        }
    ...
    throw new Error(
      "Server couldn't be reached nor remotely started. Please check stash log. If it's your first time using the plugin, installation can be long."
    );
  }
  ...
  async function createFileHandle(blob) {
    try {
      ...
      if (!handle_file || typeof handle_file !== "function") {
        throw new Error(
          "handle_file function not available from Gradio client"
        );
      }
  ...
  async function callGradioAPI(endpoint, inputs) {
    ...
    for (let attempt = 0; attempt < MAX_RETRIES; attempt++) {
      try {
        ...
        lastError = error;
        console.warn(
          `Gradio API call failed (attempt ${attempt + 1}/${MAX_RETRIES}): ${
            error.message
          }`
        );
    ...
    throw new Error(
      "Server couldnt be reach nor remotly started. Please check stash log. If its you first time using the plugin, installation can be long."
    );
  }
  ...
  function create_fragment$6(ctx) {
    ...
    return {
      c() {
        ...
        attr(li, "class", "svelte-tabs__tab svelte-localhjc");
  ...
  function create_fragment$5(ctx) {
    ...
    return {
      c() {
        ...
        attr(ul, "class", "svelte-tabs__tab-list svelte-localhje");
      },
      m(target, anchor) {
  ...
  function create_fragment$4(ctx) {
    ...
    return {
      c() {
        ...
        attr(div, "class", "svelte-tabs__tab-panel svelte-localhjd");
  ...
  function create_if_block(ctx) {
    ...
    return {
      c() {
        ...
        attr(div0, "class", "modal-body svelte-localhja");
        attr(button0, "id", "face_close");
        attr(button0, "type", "button");
        attr(button0, "class", "ml-2 btn btn-secondary svelte-localhja");
        attr(button1, "id", "face_toggle");
        attr(button1, "type", "button");
        attr(button1, "class", "ml-2 btn btn-secondary svelte-localhja");
        attr(div1, "class", "svelte-localhja");
        attr(div2, "class", "ModalFooter modal-footer svelte-localhja");
        attr(div3, "class", "modal-content svelte-localhja");
        attr(div4, "class", "modal-dialog modal-xl svelte-localhja");
        attr(div5, "role", "dialog");
        attr(div5, "aria-modal", "true");
        attr(div5, "class", "fade ModalComponent modal show svelte-localhja");
  ...
  function create_default_slot_3(ctx) {
    ...
    return {
      c() {
        ...
        attr(img, "alt", "");
        attr(img, "class", "face-tab svelte-localhja");
      },
      m(target, anchor) {
  ...
  function create_each_block_1(key_1, ctx) {
    ...
    return {
      ...
      c() {
        ...
        t5 = text("%");
        t6 = space();
        attr(img, "class", "performer-card-image svelte-localhja");
        ...
        attr(div0, "class", "thumbnail-section svelte-localhja");
        attr(
          a,
          "href",
          (a_href_value =
        ...
        attr(a, "class", "svelte-localhja");
        attr(div1, "class", "svelte-localhja");
        attr(span1, "class", "tag-item badge badge-pill svelte-localhja");
        set_style(div2, "-webkit-line-clamp", "2");
        attr(div2, "class", "svelte-localhja");
        attr(h5, "class", "card-section-title flex-aligned svelte-localhja");
        attr(div3, "class", "card-section svelte-localhja");
        attr(div4, "draggable", "false");
        attr(div4, "class", "performer-card grid-card card svelte-localhja");
  ...
  function create_default_slot_1(ctx) {
    ...
    return {
      c() {
        ...
        t = space();
        attr(div0, "class", "carousel svelte-localhja");
        attr(div1, "class", "row svelte-localhja");
      },
      m(target, anchor) {
  ...
  function create_fragment$2(ctx) {
    ...
    return {
      c() {
        ...
        button.innerHTML = `<svg xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" viewBox="0 0 16 16" class="svelte-localhjf"><path d="M5 1V3H3L3 5H1V1H5Z" fill="#FFFFFF"/>
<path d="M1 11H3V13H5V15H1V11Z" fill="#FFFFFF"/>
<path d="M15 5V1H11V3L13 3V5H15Z" fill="#FFFFFF"/>
<path d="M11 15V13H13V11H15V15H11Z" fill="#FFFFFF"/>
<path d="M5.75 7.5C6.44036 7.5 7 6.94036 7 6.25C7 5.55964 6.44036 5 5.75 5C5.05964 5 4.5 5.55964 4.5 6.25C4.5 6.94036 5.05964 7.5 5.75 7.5Z" fill="#FFFFFF"/>
<path d="M11.5 6.25C11.5 6.94036 10.9404 7.5 10.25 7.5C9.55964 7.5 9 6.94036 9 6.25C9 5.55964 9.55964 5 10.25 5C10.9404 5 11.5 5.55964 11.5 6.25Z" fill="#FFFFFF"/>
<path d="M10.5709 8.67309C9.79289 9.04269 8.92205 9.24999 8 9.24999C7.07795 9.24999 6.2071 9.04269 5.42909 8.67309L4.57091 10.4796C5.61141 10.9739 6.77486 11.25 8 11.25C9.22514 11.25 10.3886 10.9739 11.4291 10.4796L10.5709 8.67309Z" fill="#FFFFFF"/></svg>`;
        attr(button, "id", "localFaces");
        attr(button, "class", "svelte-localhjf");
  ...
  function instance$2($$self, $$props, $$invalidate) {
    ...
    function recognize() {
      ...
      html2canvas(document.querySelector(selector)).then(async (canvas) => {
        ...
        try {
          const result = await callGradioAPI("multiple_image_search", [
            await createFileHandle(imageBlob),
            THRESHOLD,
            MAX_RESULTS,
          ]);
          ...
          if (result.data[0] && Array.isArray(result.data[0])) {
            result.data[0].forEach((match) => {
              if (match.performers && Array.isArray(match.performers)) {
                match.performers.forEach((performer) => {
                  if (
                    performer.image &&
  ...
  function create_each_block(key_1, ctx) {
    ...
    return {
      ...
      c() {
        ...
        div0 = element("div");
        t = space();
        attr(div0, "class", "face-item svelte-localhjb");
        set_style(
          div0,
          "background-position",
          "-" +
        ...
        attr(div2, "class", "svelte-localhjb");
        toggle_class(
          div2,
          "selected",
  ...
  function create_fragment$1(ctx) {
    ...
    return {
      c() {
        ...
        attr(div6, "class", "face-tabs svelte-localhjb");
      },
      m(target, anchor) {
  ...
  function create_fragment(ctx) {
    ...
    return {
      c() {
        button = element("button");
        button.innerHTML = `<svg xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" viewBox="0 0 24 24" class="svelte-localhjf"><path d="M17,10.5L21,6.5V17.5L17,13.5V17A1,1 0 0,1 16,18H4A1,1 0 0,1 3,17V7A1,1 0 0,1 4,6H16A1,1 0 0,1 17,7V10.5M14,16V15C14,13.67 11.33,13 10,13C8.67,13 6,13.67 6,15V16H14M10,8A2,2 0 0,0 8,10A2,2 0 0,0 10,12A2,2 0 0,0 12,10A2,2 0 0,0 10,8Z"></path></svg>`;
        attr(button, "id", "localSceneFaces");
        attr(button, "class", "svelte-localhjf");
        toggle_class(button, "scanner", /*scanner*/ ctx[0]);
      },
      m(target, anchor) {
  ...
  function instance($$self, $$props, $$invalidate) {
    ...
    async function getFaces() {
      ...
      try {
        const result = await callGradioAPI("find_faces_in_sprite", [
          await createFileHandle(imageBlob),
          await createFileHandle(vttBlob),
        ]);
        $$invalidate(0, (scanner = false));
